...
export default function Home() {
 ...
 <div class="bg-gray-900 ">
    <div class="mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 items-center px-6 py-16 lg:px-8 lg:py-24">
     <div class="max-w-xl">
      <img src="./clabsday.png" alt="Clabs Day Outing" />
    </div>
    ...
    <div class="max-w-xl lg:mx-auto lg:pl-8">
      ...
      <ul>
        ...
        <li class="mt-4 text-gray-400">💼 Profession: Fullstack Developer</li>
        {/* <li class="mt-4 text-gray-400">🌐 Languages: JavaScript, PHP, HTML, CSS, Android</li> */}
        <li class="mt-4 text-gray-400">🌟 Interests: Web Development, Game Development, UI/UX Design</li>
        <li class="mt-4 text-gray-400">📫 Contact: xiaoyuan.drhorse@gmail.com </li>
        <li class="mt-4 text-gray-400">🔗 Socials: GitHub, LinkedIn, Twitter</li>
        ...
        <li class="mt-4 text-gray-400">🚀 Motto: "Code your dreams into reality."</li>

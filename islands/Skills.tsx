...
export default function Skills() {
  ...
  <div class="container mx-auto px-6 lg:px-16 text-center">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 justify-items-center">
      {/* Row 1 */}
      <div class="bg-gray-800 rounded-2xl px-6 py-6 flex flex-col items-center shadow-lg hover:scale-105 transition-all">
      ...
      <div class="bg-gray-800 rounded-2xl px-6 py-6 flex flex-col items-center shadow-lg hover:scale-105 transition-all">
        <img src="./swift.png" alt="SQL" class="w-10 h-10 mb-3" />
